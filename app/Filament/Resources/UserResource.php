        ...
        return $form
            ->schema([
                ...
                TextInput::make('password')
                    ...
                    ->dehydrated(fn (?string $state): bool => filled($state)), // Hanya proses jika field diisi
                Select::make('roles')
                    ->relationship('roles', 'name') // 'roles' adalah nama relasi di model User
                    ->multiple()
                    ->preload()
                    ->searchable(),
            ]);
        ...
        return $table
            ->columns([
                ...
                TextColumn::make('email')
                    ->searchable(),
                // Menampilkan role dengan tampilan badge
